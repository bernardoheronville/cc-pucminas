...
class Arvore {
    ...
    private No inserirNome(No i, Game game) {
        ...
        else if(game.getNome().compareTo(i.elemento.getNome()) > 0) i.dir = inserirNome(i.dir, game);
        else if(game.getNome().compareTo(i.elemento.getNome()) < 0) i.esq = inserirNome(i.esq, game);
        else;
        return i;
    }
...
public class Main {
    ...
    public static void main(String args[]) throws FileNotFoundException {
        ...
        while(!my_strcmp(buscaId, "FIM")) {
            ...
            No i = arvore.raiz;
            while(i != null) {
                if(idBusca > i.elemento.getID()) i = i.dir;
                else if(idBusca < i.elemento.getID()) i = i.esq;
                else {
